...
class Populaire extends StatelessWidget {
...
///appel de la liste de films populaire
static Future<List<movieModel>> fetchHomeData(http.Client client) async {

  final response =
      await client.get(Uri.parse('https://api.themoviedb.org/3/movie/popular?api_key=aee625b964853feedc62a5fa19de554f&language=fr-FR&page=1'));
     print(response.body);
